package com.sajid.configuration;
...
@EnableWebMvc
@ComponentScan(basePackages = "com.sajid")
public class AppConfig extends WebMvcConfigurerAdapter{
	...
	@Autowired
	StringToProductTypeConverter stringToProductTypeConverter;	
	
	@Autowired
	StringToBrandConverter stringToBrandConverter;	
    ...
    public void addFormatters(FormatterRegistry registry) {
        ...
        registry.addConverter(stringToBrandConverter);
    }
